...
💡 **Note:** There are detailed explanations on the gain, noise suppression, and wake word sensitivity flags in the [audio options](docs/audio_options.md) file, and the controlled entities from device page in the [dashboard](docs/dashboard.md) file.
